...
import com.mferreira.cursomc.domain.Estado;
import com.mferreira.cursomc.domain.ItemPedido;
import com.mferreira.cursomc.domain.Pagamento;
import com.mferreira.cursomc.domain.PagamentoComBoleto;
import com.mferreira.cursomc.domain.PagamentoComCartao;
...
import com.mferreira.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	Cliente cli1 = new Cliente(null, "Maria Silva", "miguelfferreira93@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));	
	cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
	
	Cliente cli2 = new Cliente(null, "Ana Costa", "mferreira@maiseficaz.pt", "05748227207", TipoCliente.PESSOAFISICA, pe.encode("123"));
